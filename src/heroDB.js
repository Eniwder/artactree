...
const herosLv4 = [
  heroLv4('ブラックヴァルキュリア', '5101', 'sword', 'dark', [herosLv3[1], herosLv3[19]]),
  heroLv4('ドラグーン', '5102', 'sword', 'fire', [herosLv3[0], herosLv3[2]]),
  heroLv4('ソードマスター', '5103', 'sword', 'fire', [herosLv3[2], herosLv3[3]]),
  heroLv4('アヴァロン', '5104', 'sword', 'ice', [herosLv3[5], herosLv3[9]]),
  heroLv4('ソウルボウ', '5201', 'arrow', 'green', [herosLv3[6], herosLv3[7]]),
  heroLv4('ダークワンダラー', '5202', 'arrow', 'dark', [herosLv3[8], herosLv3[15]]),
  heroLv4('ファルコン', '5203', 'arrow', 'ice', [herosLv3[9], herosLv3[12]]),
  heroLv4('デスペラード', '5204', 'arrow', 'fire', [herosLv3[7], herosLv3[10]]),
  heroLv4('バウンティハンター', '5301', 'assassin', 'ian', [herosLv3[14], herosLv3[36]]),
  heroLv4('ルナブレイド', '5302', 'assassin', 'ice', [herosLv3[5], herosLv3[17]]),
  heroLv4('ダルヴィーシュ', '5303', 'assassin', 'dark', [herosLv3[12], herosLv3[13]]),
  heroLv4('デーモンシャドウ', '5304', 'assassin', 'dark', [herosLv3[13], herosLv3[15]]),
  heroLv4('ロードメイジ', '5401', 'magic', 'light', [herosLv3[18], herosLv3[19]]),
  heroLv4('セージ', '5402', 'magic', 'green', [herosLv3[21], herosLv3[28]]),
  heroLv4('ヴァンパイア', '5403', 'magic', 'dark', [herosLv3[23], herosLv3[24]]),
  heroLv4('マリオネット', '5404', 'magic', 'fire', [herosLv3[20], herosLv3[30]]),
  heroLv4('ビーストロード', '5501', 'heal', 'fire', [herosLv3[25], herosLv3[34]]),
  heroLv4('ダークロード', '5502', 'heal', 'dark', [herosLv3[20], herosLv3[27]]),
  heroLv4('アークエンジェル', '5503', 'heal', 'light', [herosLv3[26], herosLv3[28]]),
  heroLv4('ヴェノムクイーン', '5504', 'heal', 'green', [herosLv3[6], herosLv3[26]]),
  heroLv4('ヘルブリンガー', '5601', 'fist', 'ice', [herosLv3[34], herosLv3[36]]),
  heroLv4('ゴッドハンド', '5602', 'fist', 'light', [herosLv3[31], herosLv3[33]]),
  heroLv4('メイジフィスト', '5603', 'fist', 'ice', [herosLv3[23], herosLv3[35]]),
  heroLv4('ドリームペインター', '5604', 'fist', 'light', [herosLv3[17], herosLv3[31]]),
  heroLv4('キャヴァリア', '5701', 'spear', 'light', [herosLv3[37], herosLv3[38]]),
  heroLv4('デュランダル', '5702', 'spear', 'dark', [herosLv3[39], herosLv3[42]]),
  heroLv4('ウォーロード', '5703', 'spear', 'ian', [herosLv3[38], herosLv3[40]]),
  heroLv4('ホーリープリンセス', '5704', 'spear', 'light', [herosLv3[30], herosLv3[42]]),
  heroLv4('ソウルランサー', '5705', 'spear', 'green', [herosLv3[21], herosLv3[37]]),
  heroLv4('ストームピア', '5706', 'spear', 'ian', [herosLv3[40], herosLv3[45]]),
  heroLv4('イフリート', '5801', 'spilit', 'fire', [herosLv3[10], herosLv3[45]]),
  heroLv4('エルライム', '5802', 'spilit', 'ice', [herosLv3[44], herosLv3[46]]),
  heroLv4('シルフィード', '5803', 'spilit', 'green', [herosLv3[47], herosLv3[48]]),
  heroLv4('リベレーター', '5804', 'spilit', 'ian', [herosLv3[0], herosLv3[44]]),
  heroLv4('エレボス', '5805', 'spilit', 'dark', [herosLv3[27], herosLv3[48]]),
]
